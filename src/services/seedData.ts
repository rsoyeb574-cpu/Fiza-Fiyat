...
export const initialProjects: Project[] = [
  {
    ...
    estimatedCost: '$1,850,000',
    costNumeric: 1850000,
    costPerSqFt: '$285 / sq.ft',
    area: '6,500 sq.ft',
    duration: '14 Months',
    structuralType: 'Post-Tensioned Concrete & Cantilevered Steel',
    floors: '3 Levels + Subterranean Wine Cellar',
    energyRating: 'LEED Platinum / Net-Zero Energy',
    bimLevel: 'LOD 400 (Fabrication & Coordination)',
    materials: ['Acoustic Triple-Glazed Glass', 'Honed Travertine Marble', 'Dark Weathering Zinc', 'Charred Yakisugi Cedar'],
    deliverables: ['Full Architectural CAD Plans', 'Revit BIM LOD 400 Model', '8K Unreal Engine 5 Cinematic Walkthrough', 'Structural & MEP Clash Reports', 'Interior Millwork Schedules'],
    costBreakdown: {
      architectural: '$120,000',
      bimAnd3d: '$48,000',
      engineering: '$65,000',
      constructionEst: '$1,617,000'
    },
    downloads: [
  ...
  },
  {
    ...
    costNumeric: 620000,
    costPerSqFt: '$138 / sq.ft',
    area: '4,500 sq.ft',
    duration: '6 Months',
    structuralType: 'Interior Architectural Fit-Out & Acoustic Framing',
    floors: '2 Levels (Duplex Penthouse)',
    energyRating: 'Estidama 3 Pearl / Smart KNX Automation',
    bimLevel: 'LOD 350 (Interior Fitout Detail)',
    materials: ['Italian Silver Travertine', 'Brushed Champagne Bronze', 'Acoustic White Oak Slats', 'Micro-Cement Floors'],
    deliverables: ['Comprehensive 3D Spatial Layouts', 'Custom Millwork Joinery Details', 'Lighting & Automation Schematics', 'Procurement Schedule & FF&E Package'],
    costBreakdown: {
      architectural: '$45,000',
      bimAnd3d: '$22,000',
      engineering: '$18,000',
      constructionEst: '$535,000'
    },
    gallery: [
      'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&w=1600&q=80',
      'https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?auto=format&fit=crop&w=1600&q=80'
  ...
  },
  {
    ...
    costNumeric: 85000,
    costPerSqFt: 'N/A (Digital Campaign)',
    area: 'Global Digital Deployment',
    duration: '2.5 Months',
    structuralType: 'Digital Brand System & Kinetic 3D Design',
    floors: 'Multi-Channel Brand System',
    energyRating: '100% Carbon-Neutral Cloud Asset Hosting',
    bimLevel: 'CGI Asset Library & Design Token System',
    materials: ['Ray-traced Chromatic Shaders', 'Liquid Metal Geometry', 'Vector Typography Suite'],
    deliverables: ['Full Brand Identity Guidelines (120 Pages)', 'Cinema 4D Kinetic Intro Stingers', 'Interactive Figma Design System (350+ Components)', '3D Holographic App Icon Set'],
    costBreakdown: {
      architectural: '$0',
      bimAnd3d: '$38,000',
      engineering: '$22,000',
      constructionEst: '$25,000'
    },
    featured: true,
    views: 2150,
    likes: 512,
  ...
  },
  {
    ...
    estimatedCost: '$24,500,000',
    costNumeric: 24500000,
    costPerSqFt: '$340 / sq.ft',
    area: '72,000 sq.ft footprint (450,000 sq.ft built-up)',
    duration: '28 Months',
    structuralType: 'Seismic Base-Isolated Steel Diagrid & Composite Core',
    floors: '62 Stories + 4 Basements',
    energyRating: 'CASBEE S-Rank / BREEAM Outstanding',
    bimLevel: 'LOD 400 / LOD 500 (As-Built Digital Twin)',
    materials: ['High-Strength Structural Steel', 'Photovoltaic Spandrel Glass', 'Aerated Lightweight Concrete Panels', 'Titanium Cladding Ribs'],
    deliverables: ['LOD 400 Multi-Discipline Revit Model (RVT)', 'Complete AutoCAD Structural Working Drawings (DWG)', 'Navisworks 4D Construction Simulation', 'Automated Clash Detection Reports', 'BIM MEP Run Takeoff Sheets'],
    costBreakdown: {
      architectural: '$850,000',
      bimAnd3d: '$420,000',
      engineering: '$780,000',
      constructionEst: '$22,450,000'
    },
    downloads: [
  ...
  },
  {
    ...
    area: '3,200 sq.ft Experiential Pop-Up',
    duration: '1.5 Months',
    structuralType: 'Modular Rapid-Deploy Aluminum Truss & LED Wall Canvas',
    floors: 'Single Level Immersive Arena',
    energyRating: '100% LED Ultra-Low Energy Array',
    bimLevel: 'AI Point Cloud & 3D Gaussian Splats',
    materials: ['Diffused Polycarbonate Panels', 'Micro-LED Neon Matrices', 'Recycled Anodized Aluminum', 'Smart Electrochromic Films'],
    deliverables: ['Custom AI Diffusion Checkpoint & LoRA', 'Interactive 3D Gaussian Splatting Web Scene', '4K Generative Video Loop Series', 'Spatial Acoustic Sound Design Stems'],
    costBreakdown: {
      architectural: '$12,000',
      bimAnd3d: '$28,000',
      engineering: '$10,000',
      constructionEst: '$15,000'
    },
    featured: true,
    views: 3100,
    likes: 742,
  ...
  },
  {
    ...
    costNumeric: 110000,
    costPerSqFt: 'N/A (SaaS Platform Architecture)',
    area: 'Global Multi-Tenant Cloud Architecture',
    duration: '3.5 Months',
    structuralType: 'Enterprise TypeScript Microservices & WebGL Canvas',
    floors: 'Digital Portal (14 Interactive Modules)',
    energyRating: '100% Green Edge-CDN Infrastructure',
    bimLevel: 'Interactive 3D WebGL Viewer Integration',
    materials: ['WebGL Shaders', 'Tailwind CSS Design Tokens', 'Framer Motion Spring Physics', 'PostgreSQL Schema'],
    deliverables: ['Production React / Next.js Source Code', 'Complete Figma UI/UX Prototype with 80+ Screens', 'Custom Three.js 3D Model Configurator', 'Automated CI/CD Pipeline & Documentation'],
    costBreakdown: {
      architectural: '$0',
      bimAnd3d: '$25,000',
      engineering: '$65,000',
      constructionEst: '$20,000'
    },
    featured: true,
    views: 1850,
    likes: 420,
